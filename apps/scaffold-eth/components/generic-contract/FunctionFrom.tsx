...
import { transactor } from '@drmg/shared/ui'; // from '~~/functions';
import { EthComponentsSettingsContext } from '@drmg/shared/ui'; // from '~~/models';
...
export const FunctionForm: FC<IFunctionForm> = (props) => {
  ...
  // >();
  const [returnValue, setReturnValue] = useState<
    string | BigNumber | ReactElement | number | undefined
  >(undefined);
